...
[cib11,rang,rangc] = Ch_seg_correctionRange_cib(CIB3D_Fill2,'150-400');
% [cob11,rang,rangc] = Ch_seg_correctionRange_cob(COB3D_Fill2,'200-750');
...
newSegPath = plt_wf_cibcob1(cropImgs1,4*cib11,4*COB3D_Fill2,filePath,nvar,rang1)

function [Iout,whatScale,Voutx,Vouty,Voutz]=Frangi1Filter3D(I,options)
%
...
for i = 1:length(sigmas),
	...
	vik=(1-((LambdaAbs2-LambdaAbs3)./(LambdaAbs2+LambdaAbs3))).*((2/3)*Lambda1-Lambda2-Lambda3);
    % Free memory
...
%     keyboard
    ...
    %Compute Vesselness function
    Voxel_data = vik.*expRa.* expRb.* expS;
